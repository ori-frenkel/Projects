...
public partial class AdminSearchFormV : System.Web.UI.Page
{
    string Condition;
    ...
    protected string ShowTable()
    {
        ...
        foreach (DataRow dr in dt.Rows)
        {
            ...
            str += "<td><a href='ViewUsersV2.aspx?username=" + dr["user_d"] + "&password=" + dr["pass_d"] + "&firstname=" + dr["fn_d"] + "&lastname=" + dr["ln_d"] + "&city=" + dr["city_d"] + "&email=" + dr["email_d"] + "'>Delete</a></td>";
            str += "<td><a href='ViewUsersV2.aspx?username2=" + dr["user_d"] + "&password2=" + dr["pass_d"] + "&firstname2=" + dr["fn_d"] + "&lastname2=" + dr["ln_d"] + "&city2=" + dr["city_d"] + "&email2=" + dr["email_d"] + "'>Update</a></td>";
            str += "</tr>";
        }
        str += "</table>";
        return str;
