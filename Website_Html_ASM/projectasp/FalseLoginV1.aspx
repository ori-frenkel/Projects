<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FalseLoginV1.aspx.cs" Inherits="FalseLoginV1" %>
...
<div class="login-page">
  <div class="form">
    ...
    <form name = "form2" id="form2" action="Insert2.aspx" method="post">
      ...
      <span style="color:red; background-color:White;" class="message"> השם משתמש או הסיסמה אינם נכונים</span>
    </form>
  </div>
</div>
