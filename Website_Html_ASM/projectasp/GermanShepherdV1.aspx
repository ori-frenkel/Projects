<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GermanShepherdV1.aspx.cs" Inherits="GermanShepherdV1" %>
...
/*------------------------------------------*/
   ...
   <script type="text/javascript">
                ...
                pic[0] = "AllDogsInfo/GermanShepherd1.jpg";
                pic[1] = "AllDogsInfo/GermanShepherd2.jpg";
                pic[2] = "AllDogsInfo/GermanShepherd3.jpg";
                pic[3] = "AllDogsInfo/GermanShepherd4.jpg";
                pic[4] = "AllDogsInfo/GermanShepherd5.jpg";
                var num=0;
                function next_img()
                {
                  num++;
...
<a href="Index.aspx"><button>דף הבית</button></a>
 ...
 <br />
  ...
  <br />
   <a href="GermanShepherdV1.aspx"><button class="active">רואה גרמני</button></a>
   <br />
