...
class Info(Frame):
    def __init__(self, master=None):
        ...
        self.t = Label(self, text="turn of player 1", font=police)
...
class Piont(object):
    def __init__(self, x, y, can, coul="white", bg="red"):
        ...
        self.r = 30
        self.piont = self.can.create_oval(self.x + 10, self.y + 10,
                                          self.x + 70, self.y + 70, fill=coul,
                                          outline="blue")
...
class Terrain(Canvas):
    ...
    def detCol(self, event):
        if self.perm:
            ...
            while lig < len(self.p):
                if self.p[0][col].coul == "red" or self.p[0][
                    0].coul == "yellow":
                    break

                if self.p[lig][col].coul == "red" or self.p[lig][
                    col].coul == "yellow":
                ...
                if self.p[lig][col].coul != "red" and self.p[lig][
                    col].coul != "yellow":
                    lig += 1

            if self.joueur == 1:
                self.joueur = 2
                info.t.config(text="turn of player 1")
                self.coul = "red"

            elif self.joueur == 2:
                self.joueur = 1
                info.t.config(text="turn of player 2")
                self.coul = "yellow"
    ...
    def Horizontal(self):
        ...
        while (i < len(self.p)):
            j = 0
            while (j < 3):
                if (self.p[i][j].coul == self.p[i][j + 1].coul == self.p[i][
                        j + 2].coul == self.p[i][j + 3].coul == "red"):
                    info.t.config(text="VIC of player 1 !")
                    self.perm = False
                    break
                elif (self.p[i][j].coul == self.p[i][j + 1].coul == self.p[i][
                        j + 2].coul == self.p[i][j + 3].coul == "yellow"):
                    info.t.config(text="VIC of player 2 !")
                    self.perm = False
                    break
                j += 1
            i += 1
    ...
    def Vertical(self):
        ...
        while (i < 3):
            ...
            while (j < len(self.p[i])):
                if (self.p[i][j].coul == self.p[i + 1][j].coul ==
                        self.p[i + 2][j].coul == self.p[i + 3][
                    j].coul == "red"):
                    info.t.config(text="Victoire de rouge !")
                    self.perm = False
                    break
                elif (self.p[i][j].coul == self.p[i + 1][j].coul ==
                          self.p[i + 2][j].coul == self.p[i + 3][
                    j].coul == "yellow"):
    ...
    def Diagonal1(self):
        ...
        while (i < 3):
            j = 0
            while (j < 3):
                if (self.p[i][j].coul == self.p[i + 1][j + 1].coul ==
                        self.p[i + 2][j + 2].coul == self.p[i + 3][
                        j + 3].coul == "red"):
                    info.t.config(text="Victoire de rouge !")
                    self.perm = False
                    break
                elif (self.p[i][j].coul == self.p[i + 1][j + 1].coul ==
                          self.p[i + 2][j + 2].coul == self.p[i + 3][
                        j + 3].coul == "yellow"):
                    info.t.config(text="Victoire de Jaune !")
                    self.perm = False
